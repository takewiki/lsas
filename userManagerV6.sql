...
from t_AccessControl a,t_ObjectType o where a.fObjectType=o.FObjectType and a.FObjectID=o.FObjectID)
 t1,  (select FUserID,FName from t_user 
  where fforbidden=0 AND (FUserID>16394 or (FUserID>9 and fuserid <16384 )) ) t2 
 ...
 ---- select * from takewiki_kingdee_list
  ...
  select FUserID,MIN(FDate) as FStartDate,MAX(fdate) as FLastLoginDate from t_Log
  group by FUserID
 ...
 create  view takewiki_kingdeeUserList as
  select a.FSubSys,a.FTypeName ,a.FItemName, a.FUserName,b.FEmpName,b.FEmpNumber,c.FStartDate,c.FLastLoginDate,b.FStatus  from  takewiki_kingdee_list a
